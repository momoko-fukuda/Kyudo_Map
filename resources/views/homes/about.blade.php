...
<div>
    ...
    <div id="aboutworry">
        ...
        <div>
            <div class="worries">
                <img src="../../images/worries1.png" alt="練習場が見つけづらい">
                <p>
            ...
            <div class="worries reverse">
                ...
                <img src="../../images/worries2.png" alt="練習できなかった">
            </div>
            <div class="worries">
                <img src="../../images/worries3.png" alt="練習場の管理">
                <p>
    ...
    <div id="solution">
        ...
        <p>弓道場のTEBIKIは、<strong>弓道を続ける上での練習場所に悩みを持つ</strong>あなたを助ける機能があります</p>
        <div>
            <div>
    ...
    <div id="howtouse">
        ...
        <div>
            <div>
                <p class="usetop"><span>シーン１：</span>どこの弓道場で練習できるかわからない</p>
                <p>
                    道場検索画面より弓道場を検索できます。
            ...
            <div>
                ...
                <a type="button" class="btn btn_check" href="{{route('mypage')}}">マイページを見に行く</a>
            </div>
        </div>
    </div>
    ...
    <div id="aboutbottom">
        <h4>みんなで弓道場の情報を集めることで、<br>楽しく・気持ちよく練習するための弓道場の手引書を作っていこう！！</h4>
        <img src="../../images/dojosearch.gif" alt="弓道場を探そう">
        <div>
            <a type="button" class="btn btn_check" href="{{route('register')}}">弓道場のTEBIKIをはじめる</a>
        </div>
    </div>
</div>
