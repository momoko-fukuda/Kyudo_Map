...
class CreateUseButtonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('use_buttons', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('use_buttonsテーブルのユニークID');
    ...
    {
        Schema::dropIfExists('use_buttons');
    }
}
